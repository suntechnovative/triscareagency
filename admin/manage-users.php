...
{			?>		
						  <tr>
							...
							<td><a href="view-user.php?pid=<?php echo htmlentities($result->ID);?>"><button type="button" class="btn btn-primary btn-block">View Details</button></a></td>
