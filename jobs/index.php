...
{	?>
  ...
  <div class="row">
    ...
    <div class="col-sm-2" style="background-color:#f9f7f7;"><h5><?php echo htmlentities($result->PackagePrice);?></h5>
					<a href="../signup.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Apply Now</a></div>
  </div>
