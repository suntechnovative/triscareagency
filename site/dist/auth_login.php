<script type="text/javascript">
  ...
  function rightAuth()
  {
    location.replace("http://localhost/tristarcareagency/site/dist/index.php");
  }
...
<html lang="en">
  ...
  <body class="bg-primary bg-pattern">
    <div class="home-btn d-none d-sm-block">
            <a href="https://localhost/tristarcareagency/admin/dist/auth-login.php"><i class="mdi mdi-home-variant h2 text-white"></i></a>
        </div>
